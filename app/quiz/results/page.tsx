...
export default function ResultsPage() {
  ...
  const getScoreMessage = () => {
    if (percentage >= 90)
      return { emoji: "🏆", title: "Privacy Superhero!", message: "Amazing! You know how to stay super safe online!" }
    if (percentage >= 70)
      return { emoji: "🌟", title: "Privacy Pro!", message: "Great job! You understand most online safety rules!" }
    if (percentage >= 50)
      return {
        emoji: "📚",
        title: "Learning Well!",
    ...
    return { emoji: "💪", title: "Keep Learning!", message: "You're on the right track! Practice makes perfect!" }
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`mb-8 ${showCelebration ? "animate-celebrate" : ""}`}>
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-primary mb-4 text-balance">Quiz Complete!</h1>
          ...
          <Card className="mb-8 border-2 border-primary/20 shadow-lg">
            <CardHeader>
              <CardTitle className="text-3xl text-primary">Your Score</CardTitle>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>
                      {totalAnswered} of {TOTAL_QUESTIONS} questions
                    </span>
                  </div>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Never share your real name, address, or phone number with strangers online
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-2xl">✅</span>
                  <div>
                    <h3 className="font-semibold mb-1">Strong Passwords</h3>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-2xl">✅</span>
                  <div>
                    <h3 className="font-semibold mb-1">Suspicious Websites</h3>
                    <p className="text-sm text-muted-foreground">
                      Always ask an adult before entering payment information
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-2xl">✅</span>
                  <div>
                    <h3 className="font-semibold mb-1">Online Strangers</h3>
                    <p className="text-sm text-muted-foreground">Never meet people from the internet in real life</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {unansweredQuestions > 0 && (
              <Link href={`/quiz/${totalAnswered + 1}`}>
                <Button size="lg" variant="secondary" className="text-lg px-6 py-3">
                  <span className="mr-2">📝</span>
                  Continue Quiz ({unansweredQuestions} left)
                </Button>
              </Link>
            )}
            <Button
          ...
          <div className="mt-12 p-6 bg-primary/10 rounded-lg border border-primary/20">
            <h3 className="text-xl font-semibold text-primary mb-2">🌟 Remember: You're a Privacy Protector! 🌟</h3>
